...
class skgeswin_16(nn.Module):
    def __init__(self, config, device):
        super(skgeswin_16, self).__init__()
        self.config = config
        ...
        # self.SC_encoder2.classifier = nn.Sequential()
        # self.SC_encoder2.avgpool = nn.Sequential()
        # self.SC_encoder2.apply(kaiming_init)
        # print(self.SC_encoder)
        # print(self.SC_encoder2)
        # ------------------------------------------------------------------------------------------------
        # feature fusion
    ...
    def forward(self, rgb_f, depth_f, next_route, velo_in):  # , gt_ss):
        ...
        # print("rg_features_7", RGB_features7.shape)
        # bagian upsampling
        ...
        # print("local_features1", global_features1.shape)
        # print("SC_features7", SC_features7.shape)
        # SC_features8 = self.downsample(SC_features7)
        # print("SC_features8", SC_features7.shape)

...
export MODEL=skgeswin #transfuser geometric_fusion late_fusion aim cilrs s13 x13
export CONTROL_OPTION=one_of #one_of both_must pid_only mlp_only, control option is only for s13 and x13 
export SAVE_PATH=/media/fachri/banyak/endtoend/data/ADVERSARIAL/${WEATHER}/${MODEL}-${CONTROL_OPTION}-old-6 # ADVERSARIAL NORMAL

...
from skgeswin.model import skgeswin
from skgeswin.config import GlobalConfig
from skgeswin.data import scale_and_crop_image, scale_and_crop_image_cv, rgb_to_depth, swap_RGB2BGR
...
def get_entry_point():
    return 'skgeswinAgent'


class skgeswinAgent(autonomous_agent.AutonomousAgent):
    def setup(self, path_to_conf_file):
        ...
        self.net = skgeswin(self.config, torch.device("cuda:0")
